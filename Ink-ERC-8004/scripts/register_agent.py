#!/usr/bin/env python3
"""Script to register InkTokenScout as an ERC-8004 agent."""
...
async def main():
    parser = argparse.ArgumentParser(description="Register InkTokenScout as ERC-8004 agent")
    parser.add_argument(
        "--endpoint",
        required=True,
        help="Public endpoint URL for the agent (e.g., https://inktokenscout.onrender.com)"
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
    ...
    print("=" * 60)
    print("InkTokenScout - ERC-8004 Agent Registration")
    print("=" * 60)
    ...
    print(f"      Chain: Ink (chainId: 57073)")
    ...
    try:
        ...
        print(f"\n      Your agent is now registered on Ink!")
        print(f"      View on Explorer: https://explorer.inkonchain.com/tx/{result['tx_hash']}")
