"""Main FastAPI application for InkTokenScout."""
...
app = FastAPI(
    title="InkTokenScout",
    description="ERC-8004 AI Agent for analyzing ERC-20 tokens on Ink blockchain",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
async def api_info():
    ...
    return {
        "name": "InkTokenScout",
        "version": "1.0.0",
        "description": "ERC-8004 AI Agent for Ink blockchain token analysis",
        "chain": "ink",
        "chain_id": 57073,
        "endpoints": {
