#!/usr/bin/env python3
"""Script to register MegaETHTokenScout as an ERC-8004 agent."""
...
async def main():
    parser = argparse.ArgumentParser(description="Register MegaETHTokenScout as ERC-8004 agent")
    parser.add_argument(
        "--endpoint",
        required=True,
        help="Public endpoint URL for the agent (e.g., https://megaethtokenscout.onrender.com)"
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
    ...
    print("=" * 60)
    print("MegaETHTokenScout - ERC-8004 Agent Registration")
    print("=" * 60)
    ...
    print(f"      Chain: MegaETH (chainId: 6342)")
    ...
    try:
        ...
        print(f"\n      Your agent is now registered on MegaETH!")
        print(f"      View on Explorer: https://megaeth.blockscout.com/tx/{result['tx_hash']}")
