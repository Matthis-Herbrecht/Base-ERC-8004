#!/usr/bin/env python3
"""Script to register RiseTokenScout as an ERC-8004 agent."""
...
async def main():
    parser = argparse.ArgumentParser(description="Register RiseTokenScout as ERC-8004 agent")
    parser.add_argument(
        "--endpoint",
        required=True,
        help="Public endpoint URL for the agent (e.g., https://risetokenscout.onrender.com)"
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
    ...
    print("=" * 60)
    print("RiseTokenScout - ERC-8004 Agent Registration")
    print("=" * 60)
    ...
    print(f"      Chain: Rise (chainId: 11155931)")
    ...
    try:
        ...
        print(f"\n      Your agent is now registered on Rise!")
        print(f"      View on Explorer: https://explorer.testnet.riselabs.xyz/tx/{result['tx_hash']}")
