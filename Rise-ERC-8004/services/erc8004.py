"""ERC-8004 agent service for Rise."""
...
class ERC8004Service:
    ...
    def generate_agent_card(self) -> Dict[str, Any]:
        return {
            ...
            "@type": "SoftwareAgent",
            "name": "RiseTokenScout",
            "description": "AI agent for analyzing ERC-20 token quality and risk on Rise blockchain",
            "version": "1.0.0",
            "capabilities": [
            ...
            "chain": {"name": "Rise", "chainId": 11155931}
        }
    ...
    async def register_agent(self, metadata_uri: str) -> Dict[str, Any]:
        ...
        tx = registry.functions.register(metadata_uri).build_transaction({
            ...
            "gasPrice": self.w3.eth.gas_price, "gas": 200000, "chainId": 11155931
        })
